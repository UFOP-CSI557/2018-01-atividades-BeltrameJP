    ...
    public Individuo executar(int _case) {
        ...
        for (int g = 1; g <= this.gmax; g++) {
            ...
            for (int i = 0; i < this.Np; i++) {
                ...
                IndividuoDouble target = null;

                switch(_case) {
                	case 0:
                		//Rand
                        target = (IndividuoDouble) populacao.getIndividuos().get(rnd.nextInt(populacao.getTamanho()));
                        break;
                	case 1:
                		//Best
                        target = (IndividuoDouble) populacao.getMelhorIndividuo();
                        break;                
                }
